...
* Hiệu năng bộ lọc làm sắc nét (Sharpening Filter): * Hiện tượng quan sát: Các đường biên, góc cạnh, phần gai và chi tiết vân trên cánh hoa được tăng cường độ tương phản rất mạnh (xuất hiện các vùng biên trắng/đen rõ rệt).
